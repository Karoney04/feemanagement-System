...
//        System.out.println(message);
        ...
        try {
            ...
            String file2 = "C:/Users/" + user + "/Documents/Leave-";
    ...
    public void printBalanceInfo(ActionEvent actionEvent) {
        ...
        try {
            ...
            Statement st = con.createStatement();
              ...
              String user = System.getProperty("user.name");
            String file2 = "C:/Users/" + user + "/Documents/Class Balance List-";
            SimpleDateFormat dFormat = new SimpleDateFormat("MM-dd-yyyy");
            Date date2 = new Date();
            String dt = dFormat.format(date2);
            dFormat = new SimpleDateFormat("HH-mm-ss-dd-MM-yyyy");
            ...
            PdfWriter.getInstance(doc, new FileOutputStream(file2 + "" + dt01 + ".pdf"));
            doc.open();
            Paragraph paragraph1 = new Paragraph("CLASS/FORM: "  +formLevel.getValue()+  "STREAM: " +stream.getValue()+  "TEARM: " +term.getValue()+"               \n                                 \n\n");
            doc.add(paragraph1);
