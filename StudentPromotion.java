...
public class StudentPromotion implements Initializable {
    ...
    ObservableList<String> Alumni = FXCollections.observableArrayList();

    int num2 = 0;
    @FXML
    private JFXComboBox<String> form4;
  ...
  //  } 
   ...
   // }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
            ...
            Alumni.addAll("Alumni");
            form4.setItems(Alumni);
            ...
            if (rs3.next()) {
                ...
                if(rs5.next()) {
                    ...
                    if(num2==1) {
                         ...
                         if(form4.getValue().equals("Alumni")){
                              int ans = JOptionPane.showConfirmDialog(null,"Add Form 4 Student to Alumni Table");
                             if (ans == 0) {
                             st2.executeUpdate("update STUDENTS set STATUS = 'A' " +
                       "where ADMMISSIONNUMBER = '" + admission + "'");
                            }                                                       
